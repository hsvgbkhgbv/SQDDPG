...
Args = namedtuple('Args', ['model_name',
                           ...
                           'target',
                           'target_lr',
                           'behaviour_policy_update_freq', # steps<-online/episodes<-offline
                           'behaviour_critic_update_freq', # steps<-online/episodes<-offline
...
args = Args(model_name=model_name,
            ...
            target=True,
            target_lr=1e-2,
            behaviour_policy_update_freq=200,
            behaviour_critic_update_freq=100,
